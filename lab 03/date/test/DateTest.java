...
class DateTest {
  ...
  @Test
  void differentObjectEquals_tc17() {
    Date today = new Date(3456, 12, 31);
    String stringObject = "3456 12 31";
    assertEquals(false, today.equals(stringObject));
  }

  @Test
  void yearsNotMatching_tc18() {
    Date today = new Date(3456, 12, 31);
    Date nextYear = new Date(3457, 12, 31);  
    assertEquals(false, today.equals(nextYear));
  }

  @Test
  void monthsNotMatching_tc19() {
    Date today = new Date(3456, 11, 30);
    Date nextMonth = new Date(3456, 12, 30);  
    assertEquals(false, today.equals(nextMonth));
  }

  @Test
  void daysNotMatching_tc20() {
    Date today = new Date(3456, 12, 30);
    Date nextDaySameMonth = new Date(3456, 12, 31);  
    assertEquals(false, today.equals(nextDaySameMonth));
  }
